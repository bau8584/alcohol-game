    ...
    return (
      <Center>
        ...
        <Card className="w-full max-w-sm text-center">
          ...
          <input value={nick} onChange={(e) => setNick(e.target.value.slice(0, 12))} placeholder="닉네임" className="clay-inset w-full px-4 py-3 text-center text-lg mb-3" onKeyDown={(e) => e.key === 'Enter' && submit()} />
          <Button className="w-full" onClick={submit}>입장</Button>
        </Card>
      </Center>
    )
  }
