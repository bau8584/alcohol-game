...
const NORMAL = [
  ...
  '민증 사진 흑역사인 사람?',
  '이번 주 운동 0회인 사람?',
  'MT에서 몰래 커플 된 적 있는 사람?',
  '술자리에서 흑기사·흑장미 해본 사람?',
  '노래방에서 탬버린 흔들다 다쳐본 사람?',
  '취해서 다음날 카톡 보고 이불킥한 적 있는 사람?',
  '지금 이 방에 몰래 좋아하는 사람 있는 사람?',
  '술김에 아무한테나 사랑한다고 해본 사람?',
  '먹다 남은 안주 몰래 다 먹어본 사람?',
  '지금 당장 집에 가고 싶은 사람?',
]
const ADULT = [
  ...
  '지금 속옷 색 기억 안 나는 사람?',
  '하룻밤에 두 번 이상 해본 사람?',
  '친구의 전 애인이랑 뭔가 있었던 사람?',
  '자기 전에 야한 거 봐야 잠드는 사람?',
  '지금 이 방 누군가랑 자는 상상 해본 사람?',
  '세 명 이상과 썸을 동시에 타본 사람?',
  '민망한 곳에서 스킨십하다 걸릴 뻔한 사람?',
  '오늘 작정하고 꾸미고 나온 사람?',
  '전 애인과의 밤이 아직도 기억나는 사람?',
]
