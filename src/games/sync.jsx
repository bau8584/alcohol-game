...
const PAIRS_ADULT = [
  ...
  ['불 켜고', '불 끄고'],
  ['아침에', '새벽에'],
  ['말 많은 애인', '행동으로 보여주는 애인'],
  ['리드하는 게 좋다', '리드당하는 게 좋다'],
  ['하룻밤 짜릿함', '오래가는 편안함'],
  ['목소리에 반함', '손에 반함'],
  ['모텔', '집'],
  ['스킨십 먼저', '대화 먼저'],
...
const QUADS_ADULT = [
  ...
  { q: '침대에서 나는', opts: ['적극파', '수줍파', '리드파', '따라가파'] },
  { q: '더 끌리는 밤', opts: ['불 켜고', '불 끄고', '촛불', '아침 햇살'] },
  { q: '가장 야한 소리', opts: ['숨소리', '이름 부르기', '웃음', '침묵'] },
  { q: '하고 싶은 코스프레', opts: ['교복', '제복', '간호사', '토끼'] },
  { q: '가장 참기 힘든 순간', opts: ['샤워하는 뒷모습', '자다 깬 목소리', '땀에 젖은', '귓속말'] },
  { q: '연인과 몰래 하고 싶은 곳', opts: ['차 안', '엘리베이터', '화장실', '베란다'] },
  { q: '받으면 설레는 터치', opts: ['목덜미', '허리', '허벅지', '귀'] },
  { q: '오늘 밤 텐션', opts: ['불타는 밤', '은은한 밤', '장난스런 밤', '푹 자는 밤'] },
]
